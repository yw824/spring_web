...
import com.leew.hello.di.Base64Encoder;
import com.leew.hello.di.Encoder;
import com.leew.hello.di.IEncoder;
import com.leew.hello.di.UrlEncoder;
...
public class Main {
    public static void main(String[] args) {
        ...
        com.leew.hello.di.Base64Encoder encoder64 = new com.leew.hello.di.Base64Encoder();
        ...
        com.leew.hello.di.Encoder encoder = new Encoder(new Base64Encoder());
